...
> OTA 寄存器定义、触发流程、状态枚举详见 [OTA升级系统开发规格说明书](../固件开发/OTA升级系统开发规格说明书.md)。
...
> `status` 枚举值（0/1/2/3/0xFF）及含义详见 [OTA升级系统开发规格说明书 §5](../固件开发/OTA升级系统开发规格说明书.md)。
...
| `ota_start`     | 先写0x0101=version，再写0x0100=1（详见 [OTA规格说明书](../固件开发/OTA升级系统开发规格说明书.md)） |