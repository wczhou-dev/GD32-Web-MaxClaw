...
const scenarios = [
  ...
  },
  {
    ...
    dependencies: ['PRE-FIELD-001', 'PRE-INSTALL-001'],
    timeoutMs: 600000,
    description: '多路传感器同时异常时系统仍基于有效路计算平均值 (精简至 4+6 路加速 ErRead)',
    inputs: {
      faultKeys: ['temp_1', 'temp_3', 'temp_5', 'temp_7'],
      normalKeys: ['temp_2', 'temp_4', 'temp_6', 'temp_8', 'temp_9', 'temp_10'],
      normalValue: 25.0,
    },
    expected: {
      actualRegister: 0x103B,
    ...
    assertions: [
      ...
      { type: '平均值正确', rule: 'actual_based_on_valid_only', tolerance: 0.5 },
