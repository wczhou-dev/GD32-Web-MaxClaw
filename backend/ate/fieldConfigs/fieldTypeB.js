/**
 * backend/ate/fieldConfigs/fieldTypeB.js
 * 佛山三水场区（配置类型 B）传感器地址表
 *
 * 数据来源：《传感器地址汇总.pdf》第6页
 * 与配置 A 的差异：TH7, TH14~16, CO2-2, CO2-8, 高位H1/H2, 室外TH, 水帘1/2
 */
...
module.exports = {
  ...
  tempHumi: {
    indoor: [
      ...
      { index: 7,  key: 'temp_7',  slaveAddr: 0x19 },   // A: 0x50
      ...
      { index: 14, key: 'temp_14', slaveAddr: 0x20 },   // A: 0x51
      { index: 15, key: 'temp_15', slaveAddr: 0x21 },   // A: 0x33
      { index: 16, key: 'temp_16', slaveAddr: 0x22 },   // A: 0x34
    ],
    outdoor: [
      { key: 'outdoor_th', slaveAddr: 0x04 },            // A: 0x18, C: 0x24
    ],
    waterCurtain: [
      { index: 1, key: 'water_1', slaveAddr: 0x13 },     // A: 0x19
      { index: 2, key: 'water_2', slaveAddr: 0x12 },     // A: 0x20
      { index: 3, key: 'water_3', slaveAddr: 0x43 },
      { index: 4, key: 'water_4', slaveAddr: 0x44 },
    ],
    highPosition: [
      { index: 1, key: 'high_h1', slaveAddr: 0x33 },     // A: 0x21
      { index: 2, key: 'high_h2', slaveAddr: 0x34 },     // A: 0x22
    ],
  },

  co2: [
    { index: 1, key: 'co2_1', slaveAddr: 0x05 },
    { index: 2, key: 'co2_2', slaveAddr: 0x10 },         // A: 0x0A
    ...
    { index: 8, key: 'co2_8', slaveAddr: 0x18 },         // A: 0x52
  ],
